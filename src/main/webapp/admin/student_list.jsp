...
<div style="padding: 15px;">
    ...
    <div class="layui-form">
        <div class="layui-form-item">
            ...
            <a href="${pageContext.request.contextPath}/adminServlet?action=toAddStudent" class="layui-btn layui-btn-normal">添加学生信息</a>
        </div>
    </div>
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${requestScope.students}" var="s">
            <tr>
                ...
                <td>${s.collegeName}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/adminServlet?action=toEditStudent&studentId=${s.studentId}" class="layui-btn layui-btn-sm">修改</a>
...
<script>
    layui.use(['layer', 'jquery', 'form'], function(){
        ...
        form.on('submit(formSearch)', function(data){
            ...
            location.href = '${pageContext.request.contextPath}/adminServlet?action=listStudents&name=' + name;
            return false;
        });
