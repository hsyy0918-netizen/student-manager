            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="${pageContext.request.contextPath}/adminServlet?action=listStudents"
                               target="mainFrame">学生管理</a></dd>
                        <dd><a href="${pageContext.request.contextPath}/adminServlet?action=listTeachers"
                               target="mainFrame">教师管理</a></dd>
                        <dd><a href="${pageContext.request.contextPath}/adminServlet?action=listCourses"
